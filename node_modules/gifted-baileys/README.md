# Gifted-Baileys - Typescript/Javascript WhatsApp Web API
...
```
yarn add github:gifted-Baileys
```
...
``` ts
import makeWASocket, { DisconnectReason } from 'gifted-baileys'
...
``` ts
import makeWASocket, { BufferJSON, useMultiFileAuthState } from 'gifted-baileys'
...
``` ts
import { MessageType, MessageOptions, Mimetype } from 'gifted-baileys'
